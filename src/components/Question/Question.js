    ...
    return (
        <div>
            ...
            <div className='container'>
                ...
                <div className='question'>
                    <h4 className='fw-bold '>2. what is difference between props and state in react?</h4>
                ...
                <div className='question'>
                    <h4 className='fw-bold '>3. What else can be done with useEffect without loading data in react?</h4>
                    <p className='fw-semibold '>Ans : Data fetching, setting up a subscription, and manually changing the DOM in React components are all examples of side effects. Whether or not you're used to calling these operations “side effects” (or just “effects”), you've likely performed them in your components before.</p>
                </div>
            </div>
        </div>
    );
